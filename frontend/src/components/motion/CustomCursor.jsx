...
export default function CustomCursor() {
  ...
  // Contextual color variables (Default: Hot Pink #ff2a6d, Verified: Emerald, Risk: Vivid Rose)
  let mainColor = "rgb(255, 42, 109)";
  let glowColor = "rgba(255, 42, 109, 0.55)";
  let dotColor = "#ff2a6d";
